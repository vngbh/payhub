---
name: divpay-unit-test-conventions
description: Use this skill when changing files inside divpayTests, especially unit tests for bill splitting, models, services, rounding, persistence, and formatting logic.
---

# Divpay Unit Test Conventions

This file applies to `divpayTests/`. Follow the root `SKILL.md` first, then these unit-test-specific rules.
