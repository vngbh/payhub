---
name: divpay-ui-test-conventions
description: Use this skill when changing files inside divpayUITests, especially UI tests for launch, main user flows, accessibility identifiers, screenshots, and simulator behavior.
---

# Divpay UI Test Conventions

This file applies to `divpayUITests/`. Follow the root `SKILL.md` first, then these UI-test-specific rules.
...
- Propose an update to `divpay/SKILL.md` when UI tests require new accessibility identifiers or app-side testability hooks.
